...
public class BaseTest {
	...
	public void setUp() throws InterruptedException {
		...
		if (PlatformUtil.isWindows()) {
			System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "\\Resource\\chromedriver_window.exe");
			...
			System.setProperty("webdriver.chrome.driver", System.getProperty("user.dir") + "\\Resource\\chromedriver_linux");
			ChromeOptions options = new ChromeOptions();
			options.addArguments("disable-infobars");
			options.addArguments("disable-notifications");
			driver = new ChromeDriver(options);
